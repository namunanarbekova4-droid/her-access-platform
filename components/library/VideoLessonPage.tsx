...
const S = {
  ...
  offlineMsg: "Video playback unavailable offline.",
  watchOnYouTube: "Watch on YouTube",
  lessonNotFound: "Lesson not found",
  noVideoSaved: "No internet connection. This lesson hasn't been saved for offline.",
  invalidUrl: "This lesson has no playable video.",
  loadError: "Failed to load lesson",
  savedToast: "Saved for offline reading ✓",
  removedToast: "Removed from downloads",
